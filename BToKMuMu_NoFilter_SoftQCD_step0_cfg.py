...
# with command line options: Configuration/GenProduction/python/BToKMuMu_NoFilter_SoftQCD_13TeV_pythia8_evtgen.py --fileout file:BToKMuMu_Soft_step0_0.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --geometry DB:Extended --era Run2_2018 --python_filename BToKMuMu_NoFilter_SoftQCD_step0_cfg.py --no_exec -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BToKMuMu_NoFilter_SoftQCD_13TeV_pythia8_evtgen.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:BToKMuMu_Soft_step0_0.root'),
...
process.mufilterPt5 = cms.EDFilter("PythiaFilter",
