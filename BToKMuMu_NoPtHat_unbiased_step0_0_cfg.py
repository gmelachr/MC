...
# with command line options: Configuration/GenProduction/python/BToKMuMu_TagFilter_HardQCD_13TeV_pythia8_evtgen.py --fileout file:BToKMuMu_NoPtHat_unbiased_step0_0.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --geometry DB:Extended --era Run2_2018 --python_filename BToKMuMu_NoPtHat_unbiased_step0_0_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(39525) -n 30
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BToKMuMu_TagFilter_HardQCD_13TeV_pythia8_evtgen.py nevts:30'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:BToKMuMu_NoPtHat_unbiased_step0_0.root'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_embedded = cms.vstring('\nAlias      MyB+        B+\nAlias      MyB-        B-\nChargeConj MyB-        MyB+\n#\nDecay MyB+\n1.000  K+      mu+     mu-    PHOTOS BTOSLLBALL 6;\nEnddecay\nCDecay MyB-\n#\nEnd\n')
        ),
...
process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(39525)
